...
class FaceScanLayout : ConstraintLayout {
    ...
    private fun render(attrs: AttributeSet?) {
        ...
        backgroundColor = a.getColor(R.styleable.FaceScanLayout_faceScan_backgroundColor, Color.WHITE)
        strokeLineWidth = a.pixels(R.styleable.FaceScanLayout_faceScan_strokeLineWidth)
        strokeLineColor = a.getColor(R.styleable.FaceScanLayout_faceScan_strokeLineColor, Color.BLACK)
        a.recycle()
    }
